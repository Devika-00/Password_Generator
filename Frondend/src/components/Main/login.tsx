              ...
              >
                {({ isValid }) => (
                  <Form>
                    ...
                    <button
                      type="submit"
                      className={`w-full py-3 mt-5 bg-blue-600 text-white rounded-md text-lg font-semibold hover:bg-blue-500 transition duration-300 focus:outline-none ${!isValid ? 'opacity-50 cursor-not-allowed' : ''}`}
                      disabled={!isValid}
                    >
                      Login
                    </button>
