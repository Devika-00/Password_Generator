...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className={`bg-white dark:bg-gray-900 shadow-md py-4 px-6 lg:px-8`}>
      <div className="container mx-auto flex items-center justify-between">
        <div className="flex-1 text-center text-2xl font-bold text-gray-900 dark:text-gray-100 mt-5 mb-4">
          Password Generator
        </div>
        <DropdownMenu>
          ...
          <DropdownMenuContent className="w-48">
            ...
            {isAuthenticated && (
              <DropdownMenuItem onClick={handlePassword}>
                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
